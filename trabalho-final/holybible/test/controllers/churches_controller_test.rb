...
class ChurchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create church" do
    assert_difference('Church.count') do
      post churches_url, params: { church: { description: @church.description, name: @church.name, user_id: @church.user_id } }
    end
  ...
  test "should update church" do
    patch church_url(@church), params: { church: { description: @church.description, name: @church.name, user_id: @church.user_id } }
